...
(() => {
  ...
  function rowHtml(row, overlays) {
    ...
    if (s.zh && displayed(row, overlays, 'zh')) parts.push(`<div class="tipitaka-zh">${esc(chineseDisplay(displayed(row, overlays, 'zh')))}</div>`);
