...
const DĀ = {
  ...
  '6': {
    // The source heading is present, but the member list needs manual
    // reconstruction; an empty array intentionally sends it to review.
    成: [], 修: ['佛念', '法念', '僧念', '戒念', '施念', '天念'], 觉: ['眼入', '耳入', '鼻入', '舌入', '身入', '意入'],
  ...
  '7': {
    ...
    灭: ['欲爱使', '有爱使', '见使', '慢使', '瞋恚使', '无明使', '疑使'], 证: [],
  },
  '8': {
    成: [], 修: ['正见', '正志', '正语', '正业', '正命', '正方便', '正念', '正定'], 觉: ['利', '衰', '毁', '誉', '称', '讥', '苦', '乐'],
